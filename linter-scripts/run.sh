...
if [ "$SKIP_LINTERS" = false ]; then
  ...
  run_linter "error-envelope-shape"  python3 "$SCRIPT_DIR/check-error-envelope-shape.py"
  ...
  run_linter "mmd-actor-order"       python3 "$SCRIPT_DIR/check-mmd-actor-order.py"
  ...
  run_linter "concurrency-conflict-ui" python3 "$SCRIPT_DIR/check-concurrency-conflict-ui.py"
  run_linter "preview-branch-parity" python3 "$SCRIPT_DIR/check-preview-branch-parity.py"
  run_linter "endpoint-operation-parity" python3 "$SCRIPT_DIR/check-endpoint-operation-parity.py"
  ...
  run_linter "shortcut-registry"          python3 "$DS_DIR/check-shortcut-registry.py"
  run_linter "analytics-events"           python3 "$DS_DIR/check-analytics-events.py"
  run_linter "command-telemetry"          python3 "$DS_DIR/check-command-telemetry.py"
  run_linter "empty-state-tags"           python3 "$DS_DIR/check-empty-state-tags.py"
  run_linter "loading-state-tags"         python3 "$DS_DIR/check-loading-state-tags.py"
  run_linter "illustration-slots"         python3 "$DS_DIR/check-illustration-slots.py"
  run_linter "blueprint-inline-literals"  python3 "$DS_DIR/check-blueprint-inline-literals.py"
  run_linter "magic-literals"             python3 "$DS_DIR/check-magic-literals.py"
  run_linter "heading-fonts"              python3 "$SCRIPT_DIR/check-heading-fonts.py"
fi
