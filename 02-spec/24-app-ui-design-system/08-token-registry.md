...
This gap is a known runtime finding recorded in `02-spec/25-app-audit/14-ui-surface-gaps.md` and will be closed by a Layer H step later in Plan 06. Until then, components MUST NOT reference tokens flagged above; they must fall back to the currently-shipped set.
