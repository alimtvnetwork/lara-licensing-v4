...
Out of scope: brand mark and logotype (owned by `.ai-memory/overview.md`); flag icons for locale switching (deferred; the app is single-locale in v1); animated Lottie files (BANNED in v1 per §11).
