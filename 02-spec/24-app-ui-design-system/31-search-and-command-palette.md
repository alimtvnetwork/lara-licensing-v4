...
Every command MUST live in a `02-spec/24-app-ui-design-system/30-command-registry.md` (deferred; §5.3 is the placeholder registry until then). Ad hoc commands wired directly into feature code are BANNED.
