...
Application-specific UI and design-system specifications for LaraLicensingV1. This module turns the actor and route inventory in `02-spec/21-app/16-ui-surfaces.md` into an implementable visual language, shell, component-state model, responsive contract, and accessibility criteria.
