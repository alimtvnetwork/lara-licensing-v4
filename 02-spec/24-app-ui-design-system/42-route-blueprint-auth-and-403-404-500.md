...
- Sign-in Button submits via a `createServerFn` per `02-spec/21-app/02-authentication-jwt.md`; MUST use `Idempotency-Key` per `29-idempotency-lifecycle.md` (rapid double-submit resolves as one attempt).
