...
- **Static link check:** every `[...](./NN-...)` link resolved by filename against the `02-spec/24-app-ui-design-system/` directory.
...
- Scans every `02-spec/24-app-ui-design-system/33-*.md` through `42-*.md` file.
