...
- `python3 .ai-memory/coding-guidelines.mdcheck-blueprint-crossrefs.py` exits 0.
- `python3 .ai-memory/coding-guidelines.mdcheck-reserved-words.py` exits 0 (one waiver
  entry remaining for `36-route-blueprint-admin-users.md :: Deactivate`, to be
  removed by CR-02).
- No em dashes in this file, verified by `rg -n em-dash-char 02-spec/24-app-ui-design-system/61-*.md`.

## 6. Consumed by

- Plan 08 (`.ai-memory/plans/done/08-execute-plan-07-steps-01-18.md`) closed all
