...
Every Select in the app MUST bind its options to a normative enum declared in `02-spec/21-app/` or `02-spec/23-app-db/`. The following registry is exhaustive for v1:
