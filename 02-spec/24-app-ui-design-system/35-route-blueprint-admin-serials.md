...
Out of scope: serial issuance itself (called from a License detail Dialog per `34-route-blueprint-admin-licenses.md` §9, not from this route); end-user serial verification (owned by `02-spec/21-app/09-verify-key.md`).
