...
- Page and actor inventory derives from `02-spec/21-app/16-ui-surfaces.md`.
- State labels derive from `02-spec/21-app/15-license-lifecycle.md`.
- Error, request-correlation, and rate-limit feedback derive from app contracts 12 through 14.
- Tokens extend the Tailwind v4 and OKLCH architecture in `02-spec/07-design-system/00-overview.md`.
