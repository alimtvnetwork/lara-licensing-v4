...
Out of scope: reseller-side quota request submission (owned by `39-route-blueprint-reseller-portal.md`, Step 36); quota accounting itself (owned by `02-spec/21-app/41-reseller-quotas.md`).
