...
The sidebar contains only routes available to the resolved role from `02-spec/21-app/16-ui-surfaces.md`. The current route uses `aria-current="page"`, a visible label, icon, and primary edge marker.
