...
Rollup of the error-management integration work landed across app-repo minor releases v0.432.0 through v0.444.0. Each app-repo release is tied to a Plan 11 step; this section records the spec-visible effect so `02-spec/03-error-manage/` stays authoritative.
