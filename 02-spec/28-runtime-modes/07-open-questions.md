...
- **Resolution**: Pinned as `?mode=` in `02-spec/28-runtime-modes/02-mode-selection-precedence.md §P-01` (v0.519.0). Underscore prefix rejected as unfriendly to bookmarks; `?rm=` rejected as opaque.
...
- **Resolution**: Pinned in `02-spec/28-runtime-modes/02-mode-selection-precedence.md §S-01..S-03` as `lara.runtime.mode`, `lara.runtime.apiBaseUrl`, `lara.runtime.previewSeed` (v0.519.0).
...
- `02-spec/28-runtime-modes/00-overview.md`: seed OQ list superseded by this ledger.
- `02-spec/28-runtime-modes/01-version-json-schema.md`, `02-mode-selection-precedence.md`, `03-preview-fixture-contract.md`, `04-generated-types-contract.md`, `05-admin-runtime-toggle.md`, `06-acceptance-criteria.md`.
