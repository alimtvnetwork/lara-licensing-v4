...
Preview handlers MUST emit only codes registered in `02-spec/03-error-manage/03-error-code-registry`. The following runtime-mode-specific codes are added by this spec:
...
- `02-spec/28-runtime-modes/00-overview.md`: INV-RM-04, INV-RM-05.
- `02-spec/28-runtime-modes/01-version-json-schema.md`: `PreviewSeed` closed set.
- `02-spec/28-runtime-modes/02-mode-selection-precedence.md`: how `Scenario` interacts with mode (only meaningful in `preview`).
- `02-spec/03-error-manage/03-error-code-registry`: canonical error codes.
