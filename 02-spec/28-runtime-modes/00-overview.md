...
- `02-spec/28-runtime-modes/01-version-json-schema.md` (Step 2): JSON Schema for `version.json`.
- `02-spec/28-runtime-modes/02-mode-selection-precedence.md` (Step 3): precedence rules formalized.
- `02-spec/28-runtime-modes/03-preview-fixture-contract.md` (Step 4): per-endpoint handler contract.
- `02-spec/28-runtime-modes/04-generated-types-contract.md` (Step 5): OpenAPI -> `src/generated/api/`.
- `02-spec/28-runtime-modes/05-admin-runtime-toggle.md` (Step 6): RBAC and persistence for the Runtime page.
- `02-spec/28-runtime-modes/06-acceptance-criteria.md` (Step 7): `AC-RM-01..AC-RM-25`.
- `02-spec/03-error-manage/`: preview handlers act as the error-code test bench (Plan 16 Step 92).
- `02-spec/07-design-system/`: empty-state guidance backing `preview-seeds/empty.ts` (Plan 16 Step 93).
- `02-spec/06-seedable-config-architecture/`: `version.json` is the runtime-config seed root (Plan 16 Step 94).

## Open Questions

Tracked in `02-spec/28-runtime-modes/07-open-questions.md` once authored (Step 8). Initial ledger:
