...
- **When** CI runs.
- **Then** the drift gate fails with a message pointing at `02-spec/28-runtime-modes/04-generated-types-contract.md §Hand-Edit Ban`.
...
- `02-spec/28-runtime-modes/00-overview.md`: INV-RM-01..INV-RM-10.
- `02-spec/28-runtime-modes/01-version-json-schema.md`, `02-mode-selection-precedence.md`, `03-preview-fixture-contract.md`, `04-generated-types-contract.md`, `05-admin-runtime-toggle.md`.
