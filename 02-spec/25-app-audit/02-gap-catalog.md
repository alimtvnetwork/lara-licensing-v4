...
| ID | Sev | Gap | Steps |
|---|---|---|---|
| A-1 | 🟡 | `02-spec/21-app/17-self-update-endpoint.md` still at v1.0 shape; v1.1.0 3-step publish state machine diff open | 1-6 |
| A-2 | 🟡 | Field-name drift between `02-spec/21-app/11-api-contracts/*` and `02-spec/23-app-db/*` (a handful of PascalCase vs snake_case slips) | 7-10 |
...
| E-6 | 🟡 | No "who can approve" matrix documented in `02-spec/21-app/19-user-management.md` | 216-220 |
