...
|---|---|---|
| A. Spec fidelity | 8% | `02-spec/21-app` internally consistent, self-referential, no drift |
...
- Prior plans still open: `.ai-memory/plans/pending/05-*.md`, `06-*.md`, `07-*.md`, `09-*.md`
