...
|---|---:|---:|---:|---|
| A. Spec fidelity | 8 | 92 | 7.36 | `02-spec/21-app/` clean, but drift with `02-spec/23-app-db` and `02-spec/24-app-ui-design-system` on a few field names (see gap A-2, A-3). |
