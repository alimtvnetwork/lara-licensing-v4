...
Version: 1.0.0
Updated: 2026-07-19
Owner: `02-spec/25-app-audit/03-plan-300-steps.md` step 1.
...
- **S21**: `02-spec/21-app/17-self-update-endpoint.md` v1.3.0 (server / wire contract).
- **S14**: `02-spec/14-update/01-self-update-overview.md` (client behaviour, no version banner).
...
- `02-spec/25-app-audit/03-plan-300-steps.md` steps 1..10.
- `02-spec/21-app/17-self-update-endpoint.md` v1.3.0.
- `02-spec/14-update/01-self-update-overview.md`.
- `02-spec/21-app/12-error-taxonomy.md` v1.2.0 (ErrorCode PascalCase rule).
- `02-spec/23-app-db/01-schema.md` §"Self-Update".
