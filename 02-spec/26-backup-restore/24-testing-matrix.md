...
| `contract`        | Request/response shape vs `02-spec/03-error-manage` envelope + BR wire.| Pact-lite JSON schema harness.             | Every PR.       |
...
| INV-BR-TS-5     | Contract tests MUST use the canonical envelope schema from `02-spec/03-error-manage/`. |
...
- [`02-spec/03-error-manage/`](../03-error-manage/00-overview.md): envelope schema used by contract tests.
- [`02-spec/25-app-audit/03-plan-300-steps.md`](../25-app-audit/03-plan-300-steps.md): where BR CI gates plug into the 300-step Band-A+ track.
