...
and render `StateForbidden` (see `02-spec/24-*`) when the check returns
...
The admin sidebar (owned by `02-spec/24-*`) MUST hide entries whose
...
`lara-diag` warning with `RequestId`, per `02-spec/03-error-manage/`.
...
- `02-spec/26-backup-restore/02-casbin-integration.md`
- `02-spec/26-backup-restore/03-permission-matrix.md`
- `02-spec/26-backup-restore/11-endpoint-export.md`
- `02-spec/26-backup-restore/12-endpoint-import.md`
- `02-spec/26-backup-restore/13-endpoint-snapshot.md`
- `02-spec/26-backup-restore/14-endpoint-restore.md`
- `02-spec/26-backup-restore/15-jobs-and-progress.md`
- `02-spec/03-error-manage/`
- `02-spec/24-*` (route shell state components)
