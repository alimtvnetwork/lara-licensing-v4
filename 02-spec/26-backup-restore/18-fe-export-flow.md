...
- Global error envelope (owned by `02-spec/03-error-manage/`).
...
`ErrorId` from the envelope (`02-spec/03-error-manage/`).
...
- `02-spec/26-backup-restore/16-idempotency-and-locks.md`
- `02-spec/26-backup-restore/17-fe-routes.md` (RA-BR-2)
- `02-spec/03-error-manage/`
- `02-spec/24-*` (StateForbidden, StateOffline, StatePending)
