...
Contract for the Windows-native publish path that uploads Lara CLI assets to the host defined in `17-self-update-endpoint.md`. This file is the deliverable form of `02-spec/25-app-audit/18-powershell-publishing.md`; where the bridge showed reasoning, this file shows the frozen contract.
...
Silent failure is banned per `02-spec/03-error-manage/`; every failure path MUST log `ERROR [<code>]` in red and `exit <top-level>`.
...
The 9560-9569 range does not collide with 9500-9552 reserved by `02-spec/11-powershell-integration/`.
...
- Endpoints consumed: `02-spec/21-app/17-self-update-endpoint.md`.
- Exit-code space: `02-spec/11-powershell-integration/` §3.
- Error-management rules: `02-spec/03-error-manage/`.
- Bridge decisions: `02-spec/25-app-audit/18-powershell-publishing.md`.
