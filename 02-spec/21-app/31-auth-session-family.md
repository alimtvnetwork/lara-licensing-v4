...
- `02-spec/21-app/02-authentication-jwt.md` §"Endpoints", §"Errors".
- `02-spec/21-app/25-retry-decision-matrix.md` for caller-side retry classes.
- `02-spec/21-app/28-audit-action-enum.md` IDs 3, 4, 5, 45, 46.
- `02-spec/21-app/11-api-contracts/01-auth-contracts.md` §`POST /Auth/Revoke` for the request/response DTO.
- `02-spec/23-app-db/01-schema.md` §"Auth Sessions".
