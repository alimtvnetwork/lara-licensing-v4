...
- AC-ROLE-005: This file MUST NOT restate the Role -> Permission matrix from [`40-permissions.md`](./40-permissions.md) §3; a duplicate table anywhere under `02-spec/21-app/` outside `40-permissions.md` is a spec defect and MUST fail the permission-parity linter added in Plan 05 Step 07.
