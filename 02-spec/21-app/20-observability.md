...
`02-spec/21-app/` prose invoked "RequestId" in the envelope but never defined who mints it, who echoes it, or what happens when it is missing. AF-CG-013 flagged this; AF-CX-103 flagged the missing `RequestIdMissing` error code path. This file locks the contract.
...
- Rate limiting: `02-spec/21-app/14-rate-limiting.md`.
- Client fix: `src/lib/lara-api-client.ts` (plan step 27).
- Coding rules: `02-spec/25-app-audit/16-coding-guideline-alignment.md` AF-CG-013.
