...
Reported: 2026-07-20
Resolved: 2026-07-20
Resolved-By: Plan 16 (`.ai-memory/plans/completed/16-preview-production-runtime-typed-api.md`), v0.517.0 - v0.606.0
...
1. Open Lovable preview at the project's `id-preview--*.ai-memory.app`.
...
- Playwright sandbox blocker for Step 97 routed to CI and documented in `02-spec/25-app-audit/06-plan16-step97-playwright-sandbox-blocker.md`.
