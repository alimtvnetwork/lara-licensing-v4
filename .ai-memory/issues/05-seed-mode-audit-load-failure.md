...
4. `02-spec/06-seedable-config-architecture/` closed-set / config seeds are not wired into the preview seeds, so admin screens that read config lookups blow up.
...
- `02-spec/06-seedable-config-architecture/**`
