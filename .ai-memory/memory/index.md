...
Canonical index of every memory file under `.ai-memory/memory/`. Each subfolder holds one file per rule, decision, or pattern. Deep-read on demand; always survey this index first.
