...
- Reconciled `.ai-memory/` folder structure and memory indexes.
- Synchronized `README.md` and `.ai-memory/what-to-read.md`.
- Enforced memory protocol constraints via `.ai-memory/memory/constraints/01-memory-protocol.md`.
...
- Removed `01-prompts/03-next-task.md`: the next-task prompt forbids mirroring itself into `01-prompts/`.
