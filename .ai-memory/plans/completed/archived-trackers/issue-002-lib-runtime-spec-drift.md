...
Plan: `.ai-memory/plans/pending/03-runtime-alignment.md`
...
- `02-spec/21-app/12-error-taxonomy.md` v1.1.0 lines 63-64 reserve `AuthRefreshRaceLost` (409) and `AuthSaltRotationFailed` (500).
...
- `02-spec/21-app/14-rate-limiting.md` AC-RL-008 line 192: `AbuseBlocked` (403) MUST NOT carry `Retry-After`.
