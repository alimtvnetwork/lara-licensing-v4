...
**Version:** 1.0.0
**Status:** Pending
**Precondition:** Plan 13 complete (spec files 00..27 under `02-spec/26-backup-restore/`).
**Handover contract:** `02-spec/26-backup-restore/27-open-questions.md` sign-off criteria.
...
`02-spec/26-backup-restore/25-migration-and-rollout.md` (S0
...
`02-spec/26-backup-restore/24-testing-matrix.md` and never opens
...
30. **Traffic ramp 100% + Plan 14 sign-off.** Move `13-*` and `14-*` plans to `.ai-memory/plans/done/`. Retro. Post-launch chaos schedule confirmed.
...
4. Update `02-spec/26-backup-restore/24-testing-matrix.md`'s
...
migrations are applied. The `.ai-memory/plans/pending/13-*.md`
