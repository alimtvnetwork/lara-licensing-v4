...
**Status:** pending
**Predecessor:** Plan 06 (complete, see `.ai-memory/plans/complete/06-spec-24-ui-fluid-swagger.md`)
**Owner queue:** spec-only until §Runtime phase.

## Objective

Green the six OPEN cross-blueprint acceptance criteria (`AC-CROSS-001..006`) surfaced by `02-spec/24-app-ui-design-system/59-cross-blueprint-audit.md`, and implement the six PENDING meta-linters listed in `60-plan-06-acceptance-report.md` §6 so that spec drift is caught by CI instead of manual audit.
