...
New folder: `02-spec/26-backup-restore/` (next free slot after 25-app-audit).
Cross-linked from `02-spec/21-app/00-overview.md` and consolidated guidelines.
...
- After user confirmation: create `02-spec/26-backup-restore/` and execute
