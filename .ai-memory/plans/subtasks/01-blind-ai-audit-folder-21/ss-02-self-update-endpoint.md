...
## Endpoints to add in `02-spec/21-app/17-self-update-endpoint.md`
...
Mirrors `02-spec/14-update/09-version-verification.md`:
...
Follows `02-spec/14-update/05-handoff-mechanism.md`: probe → download → verify sha256 → rename-active-to-.bak → rename .new-to-active → spawn handoff copy.
