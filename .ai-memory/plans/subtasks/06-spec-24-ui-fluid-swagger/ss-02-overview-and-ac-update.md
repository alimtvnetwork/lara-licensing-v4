...
# Overview + AC Update (02-spec/24-app-ui-design-system/00-overview.md, 97-acceptance-criteria.md)
...
- AC-ADS-021: Every blueprint file includes a Calls table with OperationId parity to `02-spec/26-app-api-swagger/`.
- AC-ADS-022: Every blueprint file includes a mermaid sequence snippet showing UI → API → DB flow.
- AC-ADS-023: Every blueprint declares required permission keys from `02-spec/21-app/40-permissions.md`.
...
- AC-ADS-027: Endpoint visualization sequence diagrams place EndUser far left, Admin far right per `02-spec/21-app/diagrams/00-diagram-contract.md`.
