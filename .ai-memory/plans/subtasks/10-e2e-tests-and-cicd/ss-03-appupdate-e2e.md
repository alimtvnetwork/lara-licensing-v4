...
End-to-end proof that the two-phase self-update contract (02-spec/21-app/17) works: reserve upload ticket, PUT the asset with `X-Sha256`, materialize manifest row, verify via `GET /App/UpdateManifest`, and yank.
