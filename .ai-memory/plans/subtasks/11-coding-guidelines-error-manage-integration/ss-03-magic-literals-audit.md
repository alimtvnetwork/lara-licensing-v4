...
## Goal
02-spec/02-coding-guidelines forbids magic strings/numbers in domain code. Sweep BE + FE error surfaces to route every literal through enums/config/constants.
...
- Report file: `02-spec/03-error-manage/98-magic-literals-report.md` with before/after counts.
