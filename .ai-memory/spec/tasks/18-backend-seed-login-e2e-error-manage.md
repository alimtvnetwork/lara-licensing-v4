...
Status: pending
Created: 2026-07-21
Command: `.ai-memory/02-spec/commands/11-backend-seed-login-e2e-error-manage.md`
Issue: `.ai-memory/issues/06-admin-overview-kpis-red-error.md`
...
- Spec sources of truth: `02-spec/03-error-manage/`, `02-spec/21-app/`, `02-spec/23-app-db/`, `02-spec/28-runtime-modes/`, `02-spec/02-coding-guidelines/`.
...
- AC-10: Release ceremony (`02-spec/11-release.md`) fires ONLY as the very last step, once every subtask has moved to `.ai-memory/plans/completed/`.
...
- No new runtime mode; work is within `preview` + `production` as defined in `02-spec/28-runtime-modes/`.
