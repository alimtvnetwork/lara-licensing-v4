...
- Preview seed data for closed sets, feature catalog, roles, and other config-tier tables must be derived from `02-spec/06-seedable-config-architecture/` (fundamentals + features) so backend and preview stay in lockstep.
