...
- Do NOT introduce Next.js. Stack stays TanStack Start + React 19 + Tailwind v4 per `.ai-memory/overview.md`. "Next.js-like" means modern fluid patterns (App-Router-style layouts, RSC-style data flow via loaders + server functions), not the Next.js framework itself.
